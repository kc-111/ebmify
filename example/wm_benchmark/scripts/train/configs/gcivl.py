"""Local dataclass-config for the GC-IVL trainer.

Mirrors upstream ``config/gcivl.yaml`` — single value predictor (no Q),
expectile loss + AWR actor.
"""
