"""Forked from ``upstream_scripts/data/collect_weak_pusht.py`` —
...
def main(argv: list[str] | None = None) -> int:
    ...
    out_root = datasets_root(ns.cache_dir) / (ns.out_name or "pusht_weak_100")
    ...
    for i in range(ns.num_shards):
        ...
        print(f"[collect_weak_pusht] wrote {out}")
    return 0
