...
# Source: https://github.com/galilai-group/stable-worldmodel/blob/463ab63517b043ca6c3753b01e34ea6f145497c6/scripts/train/gciql.py
...
def run(cfg):
    ...
    if cfg.get('train_value', True):
        dump_object_callback = SaveCkptCallback(
            run_name=f'{cfg.output_model_name}_value',
            cfg=cfg,
            epoch_interval=3,
        )
    ...
    dump_object_callback = SaveCkptCallback(
        run_name=f'{cfg.output_model_name}_policy',
        cfg=cfg,
        epoch_interval=3,
    )
